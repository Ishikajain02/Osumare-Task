...
import group1 from '../assets/Group 117 (2).png'
import group2 from '../assets/Group 117.png'
import group3 from '../assets/Group 117 (1).png'
import group4 from '../assets/Group 117 (2)(2).png'
import group5 from '../assets/Group 117 (3).png'
import group6 from '../assets/Group 117 (4).png'
import group7 from '../assets/Group 117 (5).png'
...
const ServiceCard = () => {
  return (
    ...
    <div className='w-[265px] h-[76px] font-OpenSans font-normal text-sm leading-[19.07px] items-center justify-center text-center'>Drive Your Success with Automotive SEO: Ignite Online Visibility and Outrace the Competition. Accelerate Your Business Growth Today
    </div>
    </div>
