...
const Header3 = () => {
  return (
    <div className='w-[1440px]  bg-gray-50 flex flex-col items-center h-[997px] bg-unique justify-center gap-[10px] mt-[232.5px] pt-[91px] pr-[81px] pb-[91px] pl-[81px]'>
        ...
        <div className='flexs'><ServiceCard/>
        </div>
       
        </div>
        <button className='w-[233px] h-[61px] rounded-[32px] pt-[16.5px] pr-[64px] pb-[16.5px] pl-[64px] gap-1 bg-blue-500 text-white'><span className='w-[107px] h-[28px] font-Montserrat font-semibold leading-7 items-center flex text-lg'>Get Started</span></button>
        </div>
    </div>
  )
}
