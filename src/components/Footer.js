  ...
  return (
    <div className='w-[1280px] h-[713px] ml-[96px] gap-8 mt-[96px] flex flex-col items-center'>
        <div className='w-[1280px] h-[657px] rounded-[32px] linear-gradient-b'>
            <div className='w-[365px] h-[160px] mt-[56px] ml-[43px] gap-4'>
            ...
            <div className='mt-[47px] w-[196px] h-[131px] ml-[43px] gap-2'>
            ...
            <div className='mt-[32px] w-[192px] h-[124px] ml-[43px] gap-6'>
